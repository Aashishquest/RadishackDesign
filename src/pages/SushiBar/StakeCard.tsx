...
export default function StakeCard({ sushiBalance, xSushiBalance }: StakeCardProps) {
    ...
    const [approvalState, approve] = useApproveCallback(     
        (chainId === 137)
        ? new TokenAmount(
            new Token(137, '0xbea6aff7067d1db51145039c6484a9b670c705ad', 18, 'RADIO', ''),
            parsedInput.value.toString()
        )  
        :
        (chainId === 4)
        ? new TokenAmount(
            new Token(4, '0x7011DE5032Fc40013bcf058D1efBD4D44b74c75A', 18, 'RADIO', ''),
            parsedInput.value.toString()
        )
        :
        (chainId === 56)
        ? new TokenAmount(
            new Token(56, '0xbea6aff7067d1db51145039c6484a9b670c705ad', 18, 'RADIO', ''),    //address need to change
            parsedInput.value.toString()
        )
        :
         new TokenAmount(
            new Token(1, '0xbea6aff7067d1db51145039c6484a9b670c705ad', 18, 'RADIO', ''),     //address need to change
            parsedInput.value.toString()
        ),
